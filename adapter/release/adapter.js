...
(function() {
  ...
  switch (browserDetails.browser) {
    ...
    case 'chrome':
      ...
      logging('adapter.mqtt shimming chrome.');
      // Export to the adapter global object visible in the browser.
    ...
    case 'firefox':
      ...
      logging('adapter.mqtt shimming firefox.');
      // Export to the adapter global object visible in the browser.
    ...
    case 'edge':
      ...
      logging('adapter.mqtt shimming edge.');
      // Export to the adapter global object visible in the browser.
    ...
    case 'safari':
      ...
      logging('adapter.mqtt shimming safari.');
      // Export to the adapter global object visible in the browser.
...
var utils = {
  disableLog: function(bool) {
    ...
    logDisabled_ = bool;
    return (bool) ? 'adapter.mqtt logging disabled' :
        'adapter.mqtt logging enabled';
  },
